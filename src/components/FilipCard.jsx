...
export default function StateBihar() {
    ...
    return (
        ...
        <div className="flex flex-col w-[90vw] sm:w-[80vw] m-auto border-2 ">
            <div className="mb-10">
                <UnderlineHeading text={"Why Choose Us"}/>
            </div>
            <div className="grid grid-cols-1 justify-center md:grid-cols-2 m-auto lg:grid-cols-4 gap-1 sm:gap-2 w-full items-center">
...
{/* Front Side */}
                                ...
                                <div className="p-2 shadow-gray-800 ">
                                    <div className="w-full flex flex-col justify-center items-center ">
                                        <div className=" text-white " >
                                            <FaGraduationCap className="w-35 h-35  text-center" />
                                        </div>
                                        <div className="" >
                                            <p className="text-xl text-white p-2 text-center"> {item.title}</p>
                                        </div>
                            ...
                            <div className="absolute inset-0 rotate-y-180 backface-hidden bg-linear-to-r rounded-2xl from-[#f4829d] to-[#155d8e] flex justify-center items-center">
                                <div className="p-2">
                                    <p className="text-sm text-white p-2 text-center">{item.description}</p>
                                </div>
                            </div>
